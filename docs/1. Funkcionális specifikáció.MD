...
- regisztrált felhasználók tudnak bejelentkezni és kilépni (Spring Security)
- regisztrált felhasználók tudnak új receptet létrehozni (név, kategória, idők, leírás, hozzávalók)
...
![PlantUML model](http://www.plantuml.com/plantuml/png/5SsnjSCW34RX_atnCe1HdyfBP01P_3QSWE18ucJzECszvRTxiCNgxUzHLThAMDR-IyJq9v7n9rqroZgMmsHeG2F9w7H01NVUW_YScq7gnEQ5hUf5XjEfWBDJvwgKXpYzd3TXHve_ReVc-ry0)
...
### Főbb oldalak:
- Az oldalak fölött fix, reszponzív navigációs sávban érhetőek el a menüpontok.
- **Home.razor (Kezdőlap)**: A belépési pont minden felhasználó számára. Tartalmazza a receptkártyák listáját, a név szerinti keresőmező és a kategóriaszűrő komponens erre az oldalra implementált.
...
A **Bejelentkezés folyamata**: A felhasználó az "Account" menüpontra kattint. A lenyíló menüben az autentikált állapotnak megfelelő menüpontok láthatóak a felhasználó számára. Látogatónak a Register és Login elérhető. A Register frontend oldali formot küld a backendnek a kötelező adatok hitelesítésére és ellenőrzésére. A Login opciót választva a rendszer ellenőrzi a JSESSIONID sütit. Ha hiányzik, a felhasználót a Spring Security bejelentkezési űrlapjára irányítja. Sikeres belépés után a frontend autentikáltnak tekinti a felhasználót.

### Regisztrált felhasználóként végezhető műveletek:

- **Új recept létrehozása**: A felhasználó az "Account" menüpontra kattintva elérheti az "Add New Recipe" gombot. Arra kattintva a megjelenő űrlapon (MudDialog) kiválasztja a kategóriát és az alapanyagokat a rendszer által kínált listából, megadja a mennyiségeket és leírja a lépéseket. Mentéskor a kliens összefűzi az adatokat és elküldi a `/recipe` POST végpontra. Siker esetén a lista frissül.
